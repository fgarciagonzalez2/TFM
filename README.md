...
- **`3_pre_procesado_V5_Gen15min.ipynb`**: Cuaderno con el preprocesado de los datos. *15 min* indica que los datos se han muestreado cada 15 minutos, que fue el intervalo seleccionado para hacer el resto del desarrollo del TFM.
...
- **`📁 notebooks/`**: Carpeta con el resto de notebooks utilizados en el TFM.
  ...
  - **`📁 cuantizacion/`**: Ficheros de cuanización del mejor modelo GRU y LSTM.
  ...
  - **`📁 preprocesado/`**: Cuadernos con el preprocesado de datos a 1, 30 y 45 minutos.
